...
public extension UITableView {
    ...
    func setEmptyView(title: String, message: String, image: UIImage?) {
        ...
        messageLabel.font = UIFont(name: AppFonts.RobotoMedium, size: 18)
...
extension UICollectionView {
    func setEmptyView(title: String, message: String, image: UIImage?) {
        ...
        titleLabel.font = UIFont(name: AppFonts.RobotoRegular, size: 18)
           messageLabel.textColor = UIColor.black
           messageLabel.font = UIFont(name: AppFonts.RobotoRegular, size: 18)
           titleLabel.text = title
           messageLabel.text = message
           messageLabel.numberOfLines = 0
           messageLabel.textAlignment = .center
...
extension UITextField{
    ...
    func addWithPlaceholder(text:String) {
        ...
        let font = UIFont.init(name: AppFonts.RobotoRegular, size: 13)
