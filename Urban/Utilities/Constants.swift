...
class Constants {
    ...
    static let baseURL = "https://www.a2itproducts.com/urbanmop/public/api/"
...
struct AppFonts {
    static let RobotoRegular =  "Montserrat-Regular"
    static let RobotoMedium =  "Montserrat-Medium"
    static let RobotoBold =  "Montserrat-Bold"
}
