...
class Utilities {
    ...
    public class func showIndicatorView() {
        ...
        activityIndicatorView = NVActivityIndicatorView(frame: CGRect(x: 0, y: 0, width: 40, height: 40), type: NVActivityIndicatorType.ballPulseSync, color: UIColor(hex: "#FF9100"), padding: 2.0)
